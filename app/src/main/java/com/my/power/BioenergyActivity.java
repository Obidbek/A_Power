...
public class BioenergyActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.bioenergy);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				textview7.setText(String.valueOf((long)((Double.parseDouble(edittext1.getText().toString()) * (Double.parseDouble(edittext2.getText().toString()) * 9.81d)) * Double.parseDouble(edittext3.getText().toString()))));
				textview9.setText(String.valueOf((long)(((Double.parseDouble(edittext1.getText().toString()) * (Double.parseDouble(edittext2.getText().toString()) * 9.81d)) * Double.parseDouble(edittext3.getText().toString())) * Double.parseDouble(edittext4.getText().toString()))));
			}
		});
	}
