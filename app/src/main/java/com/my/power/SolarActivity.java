...
public class SolarActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		quvvat = (TextView) findViewById(R.id.quvvat);
		textview8 = (TextView) findViewById(R.id.textview8);
		pul = (TextView) findViewById(R.id.pul);
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				quvvat.setText(String.valueOf((long)((Double.parseDouble(edittext1.getText().toString()) / 0.15d) * Double.parseDouble(edittext2.getText().toString()))));
				pul.setText(String.valueOf((long)(Double.parseDouble(edittext3.getText().toString()) * ((Double.parseDouble(edittext1.getText().toString()) / 0.15d) * Double.parseDouble(edittext2.getText().toString())))));
			}
		});
	}
	...
	private void initializeLogic() {
		...
		button1.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)25, 0xFF4CAF50));
	}
